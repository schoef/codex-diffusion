...
The Hermite polynomials are orthogonal with respect to $w(x)=e^{-x^2/2}/\sqrt{2\pi}$,
\begin{align}
...
\frac{(-n)_j\,(-m)_{\ell+k-j}\,(-N)_{\ell+k}\,(-\ell-k)_k}{(-N)_j\,(-N)_{\ell+k-j}\,(\ell+k-j)!\,j!\,k!}
\;{}_2F_1\!\left(
\begin{matrix}
\ell+k-j-m,\ -j\\
\ell+k-j-N
...
\paragraph{Difference operator.}
\begin{align}
\Delta K_n(x;p,N)=K_n(x+1;p,N)-K_n(x;p,N)=-\frac{n}{p}\,K_{n-1}(x;p,N-1)
\end{align}
\begin{align}
